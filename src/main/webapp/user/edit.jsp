    ...
    <div class="edit">
        <form name="editForm" action="../Controller/controller.jsp" method="post" accept-charset="UTF-8" >
            <div>
                ...
                비밀번호 : <br>
                <input type="password" size="16" name="pw" required="required"><br><br>

                이름 : <b>개명시에만 변경 가능. 고객센터로 문의 바랍니다. </b><br>
                <input type="text" size="16" name="uname" value="<%= sessionName %>" onclick="editName();" readonly><br><br>

                이메일 : <br>
                <input id = "mail" type="email" size="30" name="mail" value="<%= sessionMail %>" required="required"><br><br>

                주소 : <br>
                <input id = "addr" type="text" size="16" name="addr" value="<%= sessionAddr %>" required="required"><br><br>

                번호 : <br>
                <input id = "tel" type="text" size="16" name="tel" value="<%= sessionTel %>" required="required"><br><br>
